...
<body>
    ...
    @if (!in_array('logo', config('site.features')))
        <link
            href="https://fonts.googleapis.com/css?family=Fredoka+One&text={{ implode('', array_filter(array_map('trim', array_unique(str_split(config('site.name') . config('site.letter')))))) }}"
